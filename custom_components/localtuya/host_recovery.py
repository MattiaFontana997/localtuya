    ...
    *,
    ...
    if candidate_host == original_host:
        if not product_changed:
            return HostRecoveryResult(HostRecoveryOutcome.UNCHANGED)
        ...
        return HostRecoveryResult(HostRecoveryOutcome.METADATA_UPDATED)
    ...
    return HostRecoveryResult(HostRecoveryOutcome.UPDATED)
