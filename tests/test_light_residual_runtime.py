...
def test_color_temperature_reverse_respects_both_raw_bounds(self):
    light = self._light({"color_temp_lower": 100, "color_temp_upper": 1100, "color_temp_reverse": True})
...
def test_color_temperature_step_is_relative_to_raw_minimum(self):
    light = self._light({"color_temp_lower": 5, "color_temp_upper": 105, "color_temp_step": 10})
